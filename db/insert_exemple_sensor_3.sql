...
-- INSERT INTO `type_readings` (`id`, `description`, `min_value`, `max_value`, `prefix`) VALUES (NULL, 'temperature', '0', '100', '°C');

INSERT INTO `readings` (`id`, `date`, `hour`, `value`, `id_place`, `id_sensor`, `id_type_reading`) VALUES (NULL, '2021-03-06', '09:13:11', '85', '1', '1', '1');
