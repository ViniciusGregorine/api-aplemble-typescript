...
INSERT INTO `adresses` (`id`, `street`, `number`, `neighborhood`, `complement`, `city`) VALUES (NULL, 'avenida getulio vargas', '1514', 'são migel', 'predio preto', 'Sombrio');

INSERT INTO `institutions` (`id`, `name`, `email`, `password`, `id_adress`) VALUES (NULL, 'IFC', 'ifc@gmail.com', '1234', '1');
